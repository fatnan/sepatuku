                ...
                <div class="row no-gutters">
                    ...
                    <div class="col-md-8">
                        <div class="card-body">
                            ...
                            <p class="card-text">Harga : <?= $sepatu['total_harga']  ?></p>
                            <p class="card-text">Waktu Transaksi : <?= date('d M Y',strtotime($sepatu['waktu_transaksi']))  ?></p>
                            <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p>

                            <a href="/sepatumasuk/edit/<?= $sepatu['id_sepatumasuk']; ?>" class="btn btn-warning">Edit</a>

                            <form action="/sepatumasuk/<?= $sepatu['id_sepatumasuk']; ?>" method="post" class="d-inline">
                                <?= csrf_field(); ?>
